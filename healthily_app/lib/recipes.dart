...
//fillet
    ...
    {
    'type' : 'Fish Fillet','name': 'Parmesan Crusted Baked Fish','auth' : 'Diana Rattray',
     'time': '45 mins','cal': '180kcal',
     'image': 'https://i.ibb.co/W6Shdq5/parmesan-baked-fish-3058409-hero-01-5c82869a46e0fb00017b309b.webp',
...

{
    'type' : 'Fish Fillet','name': 'Japanese Simmered Fish','auth' : 'judy Ung',
     ...
     'image': 'https://i.ibb.co/W2tSWdL/japanese-simmering-sauce-for-fish-sakana-no-nitsuke-2030879-hero-01-86c88876daf046d5957ecf1434a92de6.webp',
     //https://www.thespruceeats.com/japanese-simmering-sauce-for-fish-sakana-no-nitsuke-2030879

  },
{
    'type' : 'Fish Fillet','name': 'Baked Halibut With Parmesan Crumb Topping','auth' : 'Diana Rattray',
     'time': '22 mins','cal': '180kcal',
     'image': 'https://i.ibb.co/tHSBDwK/baked-halibut-butter-parmesan-topping-3057312-10-preview-5b041dd70e23d9003792d9b6.webp',
     //https://www.thespruceeats.com/baked-halibut-butter-parmesan-topping-3057312

  },
{
    'type' : 'Fish Fillet','name': 'Grilled Sea Bass With Garlicg','auth' : 'Derrick Riches',
     'time': '40 mins','cal': '180kcal',
     'image': 'https://i.ibb.co/6tvbxzP/grilled-sea-bass-with-garlic-butter-recipe-334370-hero-01-c4867bcfab4847c6b16d315ff4e113bc.webp',
  ...
  },
{
    'type' : 'Fish Fillet','name': 'Fish Pakora','auth' : 'Petrina Verma Sarka',
     ...
     'image': 'https://i.ibb.co/Z1R8hrH/fish-pakora-recipe-1957611-hero-01-48677a8d10564caa9be5d226ed69012e.webp',
...
//soupf
{
    'type' : 'Fish Soup','name': 'Cioppino','auth' : 'Star Pooley ',
     ...
     'image': 'https://i.ibb.co/HVxmV8y/12816-cioppino-Allrecipes-Magazine-0aa0a97da5bd45bfb55ed5f5b893e837.webp',
...
//Veg soup
 {
    'type' : 'Veg Soup','name': 'Cold Cream of Green Pea Soup ','auth' : 'Prem Kumar Pogakula',
 ...
 {
    'type' : 'Veg Soup','name': 'Broccoli and Cheddar Soup','auth' : 'Arjun Gupta',
     'time': '40 mins','cal': '118kcal',
  ...
  },
   {
    'type' : 'Veg Soup','name': 'Vegetable Manchow Soup','auth' : 'Niru Gupta',
     ...
     'image': 'https://i.ibb.co/QMKY8wR/ae7d9ct-manchow-soup-640x480-12-September-20.jpg',
   ...
   {
    'type' : 'Veg Soup','name': 'Hearty Vegetable Soup','auth' : 'Janice Steinmetz ',
     'time': '1hr 20 mins','cal': '118kcal',
     'image': 'https://i.ibb.co/JddPBKD/moroccan-lentil-sweet-potato-soup-8-500x500.jpg',
     //https://www.tasteofhome.com/recipes/hearty-vegetable-soup/
  },
   {
    'type' : 'Veg Soup','name': 'Healing Cabbage Soup','auth' : 'JGCASE ',
     'time': '50 mins','cal': '118kcal',
     'image': 'https://i.ibb.co/yQ63fd6/82923-healing-cabbage-soup-ddmfs-4x3-0120-2847bb9e35504c658a6d677199db0c56.webp',
...
//veg salad
 ...
 {
    'type' : 'Veg Salad','name': 'Carrot Salad with Black Grape','auth' : 'Preah Narang ',
  ...
  },
{
    'type' : 'Veg Salad','name': 'Barley Salad Recipe','auth' : 'NDTV Food ',
     ...
     'image': 'https://i.ibb.co/pj5BxTM/jdd7l6a8-pav-bhaji-625x300-22-October-18.jpg',
    //https://food.ndtv.com/recipe-carrot-salad-with-black-grape-dressing-344667
  },
{
    'type' : 'Veg Salad','name': 'Green Bean Salad with Egg Topping','auth' : 'NDTV Food ',
     'time': '25 mins','cal': '118kcal',
     'image': 'https://i.ibb.co/58tT1x4/85t6l16g-pav-bhaji-625x300-22-October-18.jpg',
    //https://food.ndtv.com/recipe-green-bean-salad-with-egg-topping-98992
  },

{
    'type' : 'Veg Salad','name': ' Leafy Salad with Walnuts','auth' : 'NDTV Food ',
     'time': '25 mins','cal': '118kcal',
...
//chicken inasal
{
    'type' : 'Chicken Inasal','name': ' Chicken Inasal ','auth' : 'Lalaine Manalo ',
  ...
  },
{
  ...
  {
    'type' : 'Chicken Inasal','name': ' Chicken Inasal ','auth' : 'TOM CUNANAN ',
     'time': '35 mins','cal': '218kcal',
  ...
  // chiken soup
 {
    'type' : 'Chicken Soup','name': ' Chicken Veggie Soup ','auth' : 'Amy Cheatham ',
     'time': '30 mins','cal': '218kcal',
     'image': 'https://i.ibb.co/WBmq1LF/Chicken-Veggie-Soup-EXPS-SCBZ1806-41334-E06-28-4b-6.jpg',
    //https://www.tasteofhome.com/recipes/chicken-veggie-soup/
  },
   {
    'type' : 'Chicken Soup','name': ' Grandma’s Chicken ‘n’ Dumpling Soup','auth' : 'Paulette Balda',
     'time': '30 mins','cal': '218kcal',
    ...
    {
    'type' : 'Chicken Soup','name': 'Mexican Chicken Corn Chowder','auth' : 'Susan Garoutte',
     'time': '30 mins','cal': '218kcal',
     'image': 'https://i.ibb.co/HFnCBvN/Mexican-Chicken-Corn-Chowder-EXPS-SSBZ18-2826-B04-10-3b-2.jpg',
    //https://www.tasteofhome.com/recipes/mexican-chicken-corn-chowder/
  },
{
    'type' : 'Chicken Soup','name': 'Creamy Chicken Rice Soup','auth' : 'Janice Mitchell',
     'time': '30 mins','cal': '318kcal',
     'image': 'https://i.ibb.co/WfzfBrd/OIP.jpg',
    //https://www.tasteofhome.com/recipes/creamy-chicken-rice-soup/
  },
  {
    'type' : 'Chicken Soup','name': 'Asian Chicken Noodle Soup','auth' : 'Noelle Myers',
     'time': '40 mins','cal': '318kcal',
     'image': 'https://i.ibb.co/pXkHG9V/Asian-Chicken-Noodle-Soup-EXPS-SSMZ20-49615-E10-08-6b-3.jpg',
    //https://www.tasteofhome.com/recipes/asian-chicken-noodle-soup/
  },
  {
    'type' : 'Chicken Soup','name': 'Creamy Chicken Gnocchi Soup','auth' : 'Jaclynn Robinson',
     'time': '40 mins','cal': '318kcal',
     'image': 'https://i.ibb.co/wLyhqbt/Creamy-Chicken-Gnocchi-Soup-EXPS-SSMZ18-55269-D03-09-2b-2.jpg',
...
//beef soup
  ...
  },
  {
    'type' : 'Beef Soup','name': 'Classic Beef Stew','auth' : 'Betty Crocker',
     'time': '1hr 40 mins','cal': '318kcal',
     'image': 'https://i.ibb.co/gdwRJKN/c7f2c529-02b9-4684-b271-c34f170aad4d.jpg',
    //https://www.tasteofhome.com/recipes/hearty-beef-soup/
  },
...

  {
    'type' : 'Beef Soup','name': 'Sinigang na Baka', 'auth' : 'Ed Joven',
     'time': '1hr 40 mins','cal': '318kcal',
     'image': 'https://i.ibb.co/pvjFhP4/Getty-Images-480939965-sinigan-na-baka-photo-by-getty-images-2000-932ed0c6d7084f1380f2d849ec92d50f.webp',
    //https://www.pinoyrecipe.net/filipino-beef-bulalo-recipe-beef-bone-marrow-soup/
  },
  ...
  //Seafoods
{
  ...
  },
  {
    'type' : '"Seafoods','name': '  Greek Shrimp Orzo', 'auth' : 'Molly Seidel',
     'time': '45 mins','cal': '318kcal',
     'image': 'https://i.ibb.co/mhpGwhm/Greek-Shrimp-Orzo-EXPS-SCMZ20-117626-B01-17-7b.jpg',
    //https://www.tasteofhome.com/recipes/greek-shrimp-orzo/
  },
  {
    'type' : '"Seafoods','name': '  Shrimp and Octopus Soup', 'auth' : 'SCOOBYLADY',
     'time': '45 mins','cal': '318kcal',
     'image': 'https://i.ibb.co/4MpDHjV/5026184-797229f5837e4f4db4202d5dbea8bd30.webp',
  ...
  //fS
   {
    'type' : '"Fruit Salad','name': ' Perfect Summer Fruit Salad', 'auth' : 'Nicole Graham Holley ',
     'time': '25 mins','cal': '318kcal',
     'image': 'https://i.ibb.co/tYPBP7c/image-url-https-public-assets-meredithcorp-io-6e71582561acb8d131eec829b05d657f-1652618346-FC94-C8-F1.jpg',
    //https://www.allrecipes.com/recipe/214947/perfect-summer-fruit-salad/
  },
   {
    'type' : '"Fruit Salad','name': 'Tomato Watermelon Salad', 'auth' : ' 1insa ',
     'time': '25 mins','cal': '318kcal',
     'image': 'https://i.ibb.co/TBsjc1r/1020663-f4488803c5c745ed967140f051d0adb3.webp',
    //https://www.allrecipes.com/recipe/228277/tomato-watermelon-salad/
  },
   {
    'type' : '"Fruit Salad','name': 'Berry Fruit Salad', 'auth' : ' faulknor  ',
     'time': '25 mins','cal': '318kcal',
     'image': 'https://i.ibb.co/nQFVr0d/9155453-1bcd13cd17474504baaea2c3674c40df.webp',
  ...
  {
    'type' : '"Fruits','name': 'Perfect Banana Smoothie', 'auth' : ' Sonja and Alex ',
     'time': '15 mins','cal': '318kcal',
